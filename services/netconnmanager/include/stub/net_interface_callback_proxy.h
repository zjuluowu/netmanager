...
#ifndef NET_INTERFACE_CALLBACK_PROXY_H
#define NET_INTERFACE_CALLBACK_PROXY_H
...
class NetInterfaceStateCallbackProxy : public IRemoteProxy<INetInterfaceStateCallback> {
public:
    explicit NetInterfaceStateCallbackProxy(const sptr<IRemoteObject> &impl);
    virtual ~NetInterfaceStateCallbackProxy() = default;
...
private:
    static inline BrokerDelegator<NetInterfaceStateCallbackProxy> delegator_;
};
} // namespace NetManagerStandard
} // namespace OHOS
#endif // NET_INTERFACE_CALLBACK_PROXY_H

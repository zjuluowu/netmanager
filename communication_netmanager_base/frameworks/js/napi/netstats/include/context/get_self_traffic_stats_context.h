...
#ifndef COMMUNICATION_NETMANAGER_BASE_GET_SELF_TRAFFIC_STATS_CONTEXT_H
#define COMMUNICATION_NETMANAGER_BASE_GET_SELF_TRAFFIC_STATS_CONTEXT_H
...
class GetSelfTrafficStatsContext final : public BaseContext {
public:
    GetSelfTrafficStatsContext() = delete;
    explicit GetSelfTrafficStatsContext(napi_env env, std::shared_ptr<EventManager>& manager);
...
#endif // COMMUNICATION_NETMANAGER_BASE_GET_SELF_TRAFFIC_STATS_CONTEXT_H
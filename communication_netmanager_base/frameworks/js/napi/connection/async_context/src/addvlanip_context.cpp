...
AddVlanIpContext::AddVlanIpContext(napi_env env, std::shared_ptr<EventManager>& manager)
    : BaseContext(env, manager) {}

void AddVlanIpContext::ParseParams(napi_value *params, size_t paramsCount)
{
    if (params == nullptr) {
        return;
    }

...
#ifndef NETMANAGER_BASE_NAPI_SET_INTERFACE_IP_ADDR_H
#define NETMANAGER_BASE_NAPI_SET_INTERFACE_IP_ADDR_H
...
#endif // NETMANAGER_BASE_NAPI_SET_INTERFACE_IP_ADDR_H

...
std::map<int32_t, const char *> g_errStringMap = {
    ...
    {NETMANAGER_ERR_OPERATION_FAILED, "Failed to connect to the service"},
    ...
    {STATS_ERR_READ_BPF_FAIL, "Failed to read the system map"},
    ...
    {STATS_ERR_INVALID_GET_BPF_MAP, "Failed to create a system map"},
    ...
    {STATS_ERR_READ_DATA_FAIL, "Failed to read the database"},
    ...
    {NET_CONN_ERR_CALLBACK_NOT_FOUND, "The callback does not exist"},
    {NET_CONN_ERR_SAME_CALLBACK, "The callback already exists"},
    ...
    {NET_CONN_ERR_NET_OVER_MAX_REQUEST_NUM, "The number of requests exceeded the maximum allowed"},

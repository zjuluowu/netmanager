...
#ifndef NETMANAGER_BASE_NAPI_UNREGISTER_NET_SUPPLIER_CONTEXT_H
#define NETMANAGER_BASE_NAPI_UNREGISTER_NET_SUPPLIER_CONTEXT_H
...
#endif // NETMANAGER_BASE_NAPI_UNREGISTER_NET_SUPPLIER_CONTEXT_H

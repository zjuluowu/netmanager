...
DestroyVlanContext::DestroyVlanContext(napi_env env, std::shared_ptr<EventManager>& manager)
    : BaseContext(env, manager) {}

void DestroyVlanContext::ParseParams(napi_value *params, size_t paramsCount)
{
    if (params == nullptr) {
        return;
    }

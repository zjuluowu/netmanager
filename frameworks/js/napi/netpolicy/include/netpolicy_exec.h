...
public:
    ...
    static bool ExecGetSelfNetworkAccessPolicy(GetSelfNetworkAccessPolicyContext *context);
    ...
    static napi_value GetSelfNetworkAccessPolicyCallback(GetSelfNetworkAccessPolicyContext *context);

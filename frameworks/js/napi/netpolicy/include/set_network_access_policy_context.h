...
#ifndef NETMANAGER_BASE_NAPI_SET_NETWORK_ACCESS_POLICY_H
#define NETMANAGER_BASE_NAPI_SET_NETWORK_ACCESS_POLICY_H
...
public:
    uint32_t uid_;
    NetworkAccessPolicy policy_;
    bool isReconfirmFlag_{false};
...
#endif // NETMANAGER_BASE_NAPI_SET_NETWORK_ACCESS_POLICY_H

...
#ifndef NET_HTTP_CACHE_STRATEGY_H
#define NET_HTTP_CACHE_STRATEGY_H
...
public:
    ...
    explicit HttpCacheStrategy(HttpRequest &requestOptions);
...
#endif /* NET_HTTP_CACHE_STRATEGY_H */
